<template>
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="车场名称" prop="chechangmingcheng">
					<el-input v-model="ruleForm.chechangmingcheng" placeholder="车场名称" clearable  :readonly="ro.chechangmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="车场名称" prop="chechangmingcheng">
					<el-input v-model="ruleForm.chechangmingcheng" placeholder="车场名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="车位区号" prop="cheweiquhao">
					<el-input v-model="ruleForm.cheweiquhao" placeholder="车位区号" clearable  :readonly="ro.cheweiquhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="车位区号" prop="cheweiquhao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="车场类型" prop="chechangleixing">
					<el-input v-model="ruleForm.chechangleixing" placeholder="车场类型" clearable  :readonly="ro.chechangleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="车场类型" prop="chechangleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="状态" prop="zhuangtai">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="状态" prop="zhuangtai">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.zhuangtaiOptions = "已出售,待出售,已租出,待出租".split(',')
